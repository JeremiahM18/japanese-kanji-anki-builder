...
- Continued governed N3 core kanji Obsidian rereview in three more 8-card batches while keeping certification fail-closed: live N3 kanji is `341/341` generated, Gold, and structural Platinum; Obsidian is `48/341`; `293` Platinum entries still need substantive Obsidian proof; and `0` generated rows are blocked/failing structurally. N3 kanji NLP packets remain assistive review context only, not certification proof.
