...
- Updated N3 word lane status after the latest Sapphire batches: active Silver coverage is `1081/1081` canonical rows after expansion from `359`, N3 word Gold review from `8/1081` to `1081/1081` is complete, and Sapphire advanced from `718/1081` to `878/1081`. Gold now has `0` generated rows still missing; Sapphire has `203` generated rows still missing; Platinum remains at `8/1081` current-standard with `1073` generated rows still missing Platinum; N3-only reading readiness remains incomplete; N3 word is not locked/released; and no N3 word Obsidian proof is recorded.
