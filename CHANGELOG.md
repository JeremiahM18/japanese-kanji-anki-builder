...
- Added a program-wide review-system forward contract that locks Candidate as a pre-trust workflow state, preserves Silver/Gold/Sapphire/future Platinum/Obsidian lane authority, and keeps legacy Platinum names as compatibility history rather than new structural work.
