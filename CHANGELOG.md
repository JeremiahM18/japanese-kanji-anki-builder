...
- Added native kanji and word Platinum expert content-certification manifests, schemas, content batch reports, and fail-closed level gates; native Platinum starts at `0` coverage and requires current-standard Sapphire first.
- Added a program-wide review-system forward contract that locks Candidate as a pre-trust workflow state, preserves Silver/Gold/Sapphire/Platinum/Obsidian lane authority, and keeps legacy Platinum names as compatibility history rather than new structural work.
...
- Added governed N5, N4, and N3 kanji card-field source contracts derived from current-standard structural Japanese-source evidence, with manual field-bound citation limits, source-origin independence context, loader/audit tests, and tracked-source kanji preflight certification for N5/N4/N3 source availability.
- Completed the governed N2 kanji structural review lane, now represented as native Sapphire plus legacy compatibility history, and canonical N2 kanji Obsidian proof ledger at `349/349` with `0` remaining and `0` blocked/failing, while keeping release readiness unclaimed.
...
- Split forward Platinum commands from legacy structural/proof-provider compatibility: `deck:platinum:batch`, `deck:platinum:n*`, `deck:words:platinum:batch`, and `deck:words:platinum:n*` now mean native expert content certification only, while old structural/proof-provider reports use explicit `legacy-platinum` names.
...
- Completed the governed N4 word Obsidian proof lane while keeping certification fail-closed: N5 word Obsidian is `287/287`, N4 word native Sapphire structural coverage is `700/700`, N4 word Obsidian is `700/700`, total N5/N4 word Obsidian is `987/987`, `0` N4 rows still need Obsidian proof, and `0` generated N5/N4 word rows are blocked/failing.
...
- Expanded and governed the word inventory and reading-coverage work across N5/N4 while preserving separate Silver, Gold, Sapphire, Platinum, and Obsidian semantics; N3/N2/N1 word surfaces remain Silver starter material and do not imply release certification.
