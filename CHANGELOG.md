...
- Updated N3 word lane status after the latest Sapphire batches: active Silver remains `1081/1081` canonical rows, N3 word Gold review from `8/1081` to `1081/1081` is complete, Gold now has `0` generated rows still missing, and current-standard Sapphire advanced from `878/1081` to `958/1081` with `123` generated rows still missing Sapphire. Platinum remains `8/1081` current-standard with `1073` generated rows still missing Platinum; N3-only reading readiness remains incomplete; N3 word is not locked/released; and no N3 word Obsidian proof is recorded.
