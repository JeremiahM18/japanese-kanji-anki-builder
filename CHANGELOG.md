...
- Completed the governed N3 core kanji current-standard Platinum lane while keeping Obsidian fail-closed: live N3 kanji is `341/341` generated, Gold, and structural Platinum; Obsidian is `0/341`; `341` Platinum entries still need substantive Obsidian proof; and `0` generated rows are blocked/failing structurally.
