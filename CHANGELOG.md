...
- Expanded active N3 word Silver coverage from `359` to `1017` canonical rows. The scoped `0.2.0` lock remains limited to N5/N4 words plus N5/N4/N3/N2 core kanji; N3 word is not locked/released. Gold, Sapphire, and Platinum remain at `8/1017` current-standard in this lane, and no N3 word Obsidian proof is recorded.
