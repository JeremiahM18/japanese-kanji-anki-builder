...
- Started governed N3 core kanji Obsidian rereview in three 8-card batches while keeping certification fail-closed: live N3 kanji is `341/341` generated, Gold, and structural Platinum; Obsidian is `24/341`; `317` Platinum entries still need substantive Obsidian proof; and `0` generated rows are blocked/failing structurally. N3 kanji NLP packets were generated and used only as assistive review context, not certification proof.
