...
- Added a `data:verify:jlpt` validation command and dataset contract coverage for the canonical per-level kanji inventory so local JLPT dataset regressions fail fast.
