...
- N4 word work has `288/1034` current word Obsidian v2.5 certification. Gold, current-standard Sapphire, and current-standard Platinum are complete at `1034/1034`. The `700` older N4 Obsidian proof targets remain legacy history, not current v2.5 certification; `746` Platinum-passing rows still need separate substantive Obsidian v2.5 proof.
...
Current word Obsidian v2.5 certification covers `876/1622` across current N5/N4 generated rows, with N5 at `588/588` and N4 at `288/1034`; older word Obsidian proof is legacy history, not current v2.5 certification. N4 Gold, current-standard Sapphire, and current-standard Platinum are complete at `1034/1034`; `746` N4 rows need separate substantive Obsidian v2.5 proof. No lower-lane or Platinum count is itself a downstream certification claim.
