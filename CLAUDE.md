...
Current word Obsidian v2.5 certification covers `588/1307` across current N5/N4 generated rows, with N5 at `588/588` and N4 at `0/719`; older word Obsidian proof is legacy history, not current v2.5 certification. Lower-lane prerequisites are complete for the `588` certified N5 rows; the `700` older N4 proof targets need Obsidian v2.5, and the 19 current N4 word v2 Silver additions still need Gold, Sapphire, Platinum, and Obsidian before any downstream certification claim.
