...
- N5 word work has a `308/546` strict Obsidian-certified subset plus 238 current word v2 dictionary-common-pool Silver additions; keep the certified subset frozen except for regressions or explicit editorial decisions, and do not claim the remaining Silver rows as downstream-certified
...
N5 and N4 Obsidian-certified subsets are strict Obsidian-certified at `1008/1265` across current N5/N4 generated rows, with N5 at `308/546` and N4 at `700/719`. Lower-lane prerequisites are complete for that certified subset, but the 238 current N5 word v2 Silver additions and 19 current N4 word v2 Silver additions still need Gold, Sapphire, Platinum, and Obsidian before any downstream certification claim.
