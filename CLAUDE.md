...
- N5 word work has a `308/519` strict Obsidian-certified subset plus 211 current word v2 dictionary-common-pool rows without Obsidian proof. Gold and Sapphire are complete at `519/519`, current-standard Platinum is `438/519`, and 81 current N5 rows still need Platinum before Obsidian; keep the certified subset frozen except for regressions or explicit editorial decisions, and do not claim the remaining rows as downstream-certified.
...
N5 and N4 Obsidian-certified subsets are strict Obsidian-certified at `1008/1238` across current N5/N4 generated rows, with N5 at `308/519` and N4 at `700/719`. Lower-lane prerequisites are complete for that certified subset, but the 211 current N5 word v2 rows without Obsidian proof still need Obsidian, including 81 that still need current-standard Platinum first, and the 19 current N4 word v2 Silver additions still need Gold, Sapphire, Platinum, and Obsidian before any downstream certification claim.
