...
- N5 word work has `300/588` current word Obsidian v2.5 certification. Gold, Sapphire, and current-standard Platinum are complete at `588/588`; the remaining `288` rows need real Obsidian v2.5 rereview, example-sentence quality judgment before sentence audio, exact sentence-audio proof, and governed JSONL proof. Legacy N5 Obsidian history remains audit-visible for `418` targets, but it is not current v2.5 certification.
...
Current word Obsidian v2.5 certification covers `300/1307` across current N5/N4 generated rows, with N5 at `300/588` and N4 at `0/719`; older word Obsidian proof is legacy history, not current v2.5 certification. Lower-lane prerequisites are complete for the `300` certified N5 rows; the remaining `288` N5 rows need Obsidian v2.5, the `700` older N4 proof targets need Obsidian v2.5, and the 19 current N4 word v2 Silver additions still need Gold, Sapphire, Platinum, and Obsidian before any downstream certification claim.
