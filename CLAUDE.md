...
- N4 word work has `0/1034` current word Obsidian v2.5 certification. Gold and current-standard Sapphire are complete at `1034/1034`; current-standard Platinum is `756/1034`, leaving `278` rows in the expected Platinum backlog. The `700` older N4 Obsidian proof targets remain legacy history, not current v2.5 certification; all `756` Platinum-passing rows still need separate Obsidian v2.5 proof.
...
Current word Obsidian v2.5 certification covers `588/1622` across current N5/N4 generated rows, with N5 at `588/588` and N4 at `0/1034`; older word Obsidian proof is legacy history, not current v2.5 certification. N4 Gold and current-standard Sapphire are complete at `1034/1034`; `756` current-standard Platinum rows need separate Obsidian v2.5 proof, and `278` rows still need Platinum before Obsidian. No lower-lane or Platinum count is itself a downstream certification claim.
