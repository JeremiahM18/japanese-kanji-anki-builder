...
- N4 word work has `0/1034` current word Obsidian v2.5 certification. Gold and current-standard Sapphire are complete at `1034/1034`; current-standard Platinum is `988/1034`, leaving `46` rows in the expected Platinum backlog. The `700` older N4 Obsidian proof targets remain legacy history, not current v2.5 certification; all `988` Platinum-passing rows still need separate Obsidian v2.5 proof.
...
Current word Obsidian v2.5 certification covers `588/1622` across current N5/N4 generated rows, with N5 at `588/588` and N4 at `0/1034`; older word Obsidian proof is legacy history, not current v2.5 certification. N4 Gold and current-standard Sapphire are complete at `1034/1034`; `988` current-standard Platinum rows need separate Obsidian v2.5 proof, and `46` rows still need Platinum before Obsidian. No lower-lane or Platinum count is itself a downstream certification claim.
