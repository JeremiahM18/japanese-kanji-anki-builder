...
| `npm run data:template:jlpt:textbook-source -- --source=shin_kanzen_master_kanji --level=5` | Create an ignored manual-review worksheet for one Japanese-published textbook source lane |
