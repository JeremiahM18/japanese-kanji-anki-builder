...
| N3 word | `359` canonical Silver rows build at `359/359`; single-level readiness is incomplete; the N3-only ready run reports reading coverage `25.4%` (`301/1184`), while the completion audit with easier decks counted reports `28.5%` (`337/1184`). Gold, Sapphire, and Platinum are `8/359` current-standard with `351` generated rows still missing each lane. Obsidian proof is not recorded/certified for N3 words. | `deck:words:ready -- --levels=3`, `deck:words:review:n3`, `deck:words:sapphire:n3`, `deck:words:platinum:n3`, `deck:words:completion:n3`, `deck:words:reading-audit:n3` |
