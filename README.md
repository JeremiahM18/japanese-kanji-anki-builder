...
| N4 kanji | Golden-reviewed; current local deck readiness passes with complete exported media and exact primary-reading audio; platinum review is in progress with `102/212` active entries: `60/212` current-standard entries, `42` legacy/unversioned entries, and `110` cards still missing platinum coverage |
