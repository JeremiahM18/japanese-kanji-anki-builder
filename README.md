...
| N3 word | `1041` canonical Silver rows build/package at `1041/1041` with audio, pitch, and required back-side fields complete; reading-coverage readiness remains incomplete. The N3-only ready run reports reading coverage `82.3%` (`974/1184`), while the completion audit with N5/N4 counted reports `84.8%` (`1004/1184`). Gold, Sapphire, and Platinum are `8/1041` current-standard with `1033` generated rows still missing each lane. Obsidian proof is not recorded for N3 words. | `deck:words:ready -- --levels=3`, `deck:words:review:n3`, `deck:words:sapphire:n3`, `deck:words:platinum:n3`, `deck:words:completion:n3`, `deck:words:reading-audit:n3` |
