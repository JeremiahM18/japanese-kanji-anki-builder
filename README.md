...
| N3 word | `309` canonical Silver rows build at `309/309`; single-level readiness is incomplete; the N3-only ready run reports reading coverage `20.4%` (`242/1184`). Gold, Sapphire, and Platinum are `8/309` current-standard with `301` generated rows still missing each lane. Obsidian proof is not recorded/certified for N3 words. | `deck:words:ready -- --levels=3`, `deck:words:review:n3`, `deck:words:sapphire:n3`, `deck:words:platinum:n3`, `deck:words:completion:n3`, `deck:words:reading-audit:n3` |
