...
| N4 kanji | Golden-reviewed; current local deck readiness passes with complete exported media and exact primary-reading audio; current-standard platinum is `150/212`; no legacy/unversioned review-history entries remain active or certifying; `62` cards still need current-standard platinum coverage |
