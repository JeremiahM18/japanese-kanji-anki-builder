...
| N3 word | `59` canonical rows. Silver generated surface now builds at `59/59` with required back-side fields `649/649`, word audio `59/59`, Kanjium pitch `59/59`, reading breakdowns, and deck-policy checks passing for those rows; readiness is still `incomplete`, cumulative reading coverage is `101/1232` (`8.2%`), the Tanos N3 vocabulary lane has `569` remaining untriaged review candidates, and Gold/Platinum/Obsidian are not started. | `deck:words:ready -- --levels=3`, `deck:words:completion:n3`, `deck:words:reading-audit:n3`, `deck:words:triage:n3`, `deck:words:gap-plan:n3`, `deck:words:expansion-candidates:n3` |
