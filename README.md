...
| N4 word | `700` canonical rows after finishing the routed N5-source target-N4 move workload. The generated card surface builds at `700/700` with word audio, pitch, required back-side fields, word-level placement, examples, and labels complete; live readiness is `ready_with_deferred_variants` with reading coverage `76.7%` (`579/755`) and no active review-needed/actionable reading backlog. Gold and Platinum now cover `700/700`; stricter Obsidian enforcement currently certifies `64/700`, so `636` N4 word rows still need square-zero substantive rereview before release-ready claims. | `deck:words:ready -- --levels=4`, `deck:words:completion:n4`, `deck:words:review:n4`, `deck:words:platinum:n4`, `deck:words:platinum:certify-status -- --levels=4`, `deck:words:expansion-signals -- --levels=5,4` |
...
Word Platinum uses `word-platinum-v3-evidence-lanes`. Current N5/N4 generated word denominator is `987` rows. Structural Platinum is `987/987`, stricter Obsidian proof is `351/987`, `636` Platinum entries need Obsidian, and `0` generated N5/N4 word rows are blocked/failing structurally. The word source-posture report is scoped to the `987` structurally current-standard entries: `121/987` have independent source families proven, `866/987` are single-source-family, and `0/987` are missing governed source evidence; single-source entries carry `word_source_independence_not_proven`.
...
- `deck:words:platinum:rereview-status -- --levels=5,4` uses generated word rows as the denominator. N5 word `287/287` and N4 word `64/700` Obsidian remain separate from `987/987` structural Platinum, and `636` N5/N4 word Platinum entries still need substantive Obsidian rereview proof.
- `deck:words:platinum:certify-status -- --levels=5,4` is the fail-closed word Obsidian gate. It currently fails because `636` generated N4 word rows still need card-bound strict Obsidian proof.
