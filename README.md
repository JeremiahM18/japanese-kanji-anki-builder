...
| N4 word | `667` canonical rows. Gold and word-level placement pass, but readiness is still `incomplete`. Platinum coverage is `528/667`; Obsidian is `0/667`; `139` rows still lack active current-standard structural entries. | `deck:words:platinum:n4`, `deck:words:completion:n4`, `deck:words:gap-plan:n4` |
...
Word Platinum uses `word-platinum-v3-evidence-lanes`. Current N5/N4 word status is `815/954` Platinum pass, `8/954` Obsidian certified, `807` Platinum entries needing Obsidian, and `139` blocked/failing rows due to incomplete N4 structural coverage. The word source-posture report currently marks `115/815` structurally current-standard word entries with independent source families proven, `700/815` as single-source-family, and `0/815` as missing governed source evidence; single-source entries carry `word_source_independence_not_proven`.
...
- `deck:words:platinum:rereview-status -- --levels=5,4` uses generated word rows as the denominator. N4 word `0/667` Obsidian means `0/667`, not `0/528`.
