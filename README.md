...
| N5 word | Golden-reviewed at `327/327`; `ready_with_deferred_variants` in curated-only mode; audio, pitch accent, card-back fields, example reading alignment, and looping animations are complete for shipped rows; word platinum has 197 active approvals, 21 deferred/removed rows, 130 generated rows still missing platinum approval, and no `needs_review` blockers under the generated-pitch-label policy |
...
- N5 canonical word rows: `327`
- N5 source-only phrase exclusions: `17`
- N4 canonical word rows: `458`
- N3 canonical word rows: `8`
- N2 canonical word rows: `4`
- N1 canonical word rows: `3`
- Current N5+N4 word rows: `785`
- N5 word reading coverage: `76.5% (263/344)` when built alone
- N5 word reading coverage: `77.9% (268/344)` when built with N4 as the selected word-product scope
