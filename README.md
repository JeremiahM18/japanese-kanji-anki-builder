...
| Surface | Current state | Main gates |
| --- | --- | --- |
| N5 word | `308/519` strict word Obsidian-certified. N5 Gold and Sapphire are complete at `519/519`, and current-standard Platinum is `438/519`; the 211 current N5 word rows without Obsidian proof are generated-ready with word audio, pitch, required back-side fields, examples, reading breakdowns, support labels, readiness, Gold regression, and Sapphire coverage, but they have not completed Obsidian proof, and 81 still need current-standard Platinum before Obsidian. No N5 source-only phrase exclusions remain in the tracked word contract. Live readiness is `ready_with_deferred_variants`; reading coverage is `69.2%` (`238/344`). Release artifact QA, accessibility, and listening checks are still required before release-ready product claims. | `deck:words:obsidian:certify-status -- --levels=5`, `deck:words:ready -- --levels=5` |
...
Strict word Obsidian proof covers `1008/1238` current N5/N4 generated word rows: the N5 Obsidian-certified subset is `308/519`, and the N4 Obsidian-certified subset remains `700/719` after the current word v2 common-word Silver additions. Native Sapphire structural coverage and current-standard Platinum card-surface inspection are complete lower-lane prerequisites for the certified subset; the 211 remaining N5 rows without Obsidian proof and 19 N4 Silver rows must not be described as Obsidian-certified, and the 81 current N5 rows without current-standard Platinum must not be described as Platinum-certified.
...
- `deck:words:obsidian:rereview-status -- --levels=5,4` uses generated word rows as the denominator and defaults to canonical JSONL proof for migrated N5/N4 word ledgers. This legacy proof consumer still reports the structural column as Platinum compatibility while native `deck:words:sapphire:*` owns Sapphire coverage. The N5 word `308/519` and N4 word `700/719` Obsidian-certified subsets remain separate from current N5/N4 rows without Obsidian proof.
- `deck:words:obsidian:certify-status -- --levels=5,4` is the fail-closed word Obsidian gate. It is expected to fail for the current full N5/N4 generated denominator until the 211 remaining N5 rows without Obsidian proof complete Obsidian, including 81 that still need current-standard Platinum first, and the 19 N4 Silver rows complete Gold, Sapphire, Platinum, and Obsidian.
