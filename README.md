...
| Surface | Current state | Main gates |
| --- | --- | --- |
| N5 word | `287` canonical rows plus `20` source-only phrase exclusions. Gold, readiness, tracked-source artifact, and Platinum pass at `287/287`, but stricter word Obsidian enforcement currently certifies only `242/287`; `45` generated N5 word rows need square-zero Obsidian rereview before release-ready claims. | `deck:words:platinum:n5`, `deck:words:platinum:rereview-status -- --levels=5,4`, `deck:words:platinum:certify-status -- --levels=5` |
...
Word Platinum uses `word-platinum-v3-evidence-lanes`. Current N5/N4 generated word denominator is `987` rows. Structural Platinum is `987/987`, stricter Obsidian proof is `258/987`, `729` Platinum entries need Obsidian, and `0` generated N5/N4 word rows are blocked/failing structurally. The word source-posture report is scoped to the `987` structurally current-standard entries: `121/987` have independent source families proven, `866/987` are single-source-family, and `0/987` are missing governed source evidence; single-source entries carry `word_source_independence_not_proven`.
...
- `deck:words:platinum:rereview-status -- --levels=5,4` uses generated word rows as the denominator. N5 word `242/287` and N4 word `16/700` Obsidian remain separate from `987/987` structural Platinum, and `729` N5/N4 word Platinum entries still need substantive Obsidian rereview proof.
- `deck:words:platinum:certify-status -- --levels=5,4` is the fail-closed word Obsidian gate. It currently fails because `729` generated N5/N4 word rows still need card-bound strict Obsidian proof.
