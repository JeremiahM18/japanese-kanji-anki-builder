...
| N3 word | `713` canonical Silver rows build/package at `713/713` with audio, pitch, and required back-side fields complete; reading-coverage readiness remains incomplete. The N3-only ready run reports reading coverage `57.4%` (`680/1184`), while the completion audit with N5/N4 counted reports `60.2%` (`713/1184`). Gold, Sapphire, and Platinum are `8/713` current-standard with `705` generated rows still missing each lane. Obsidian proof is not recorded for N3 words. | `deck:words:ready -- --levels=3`, `deck:words:review:n3`, `deck:words:sapphire:n3`, `deck:words:platinum:n3`, `deck:words:completion:n3`, `deck:words:reading-audit:n3` |
