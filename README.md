...
| N3 word | `119` canonical rows. Silver generated surface now builds at `119/119` with required back-side fields `1309/1309`, word audio `119/119`, Kanjium pitch `119/119`, reading breakdowns, and deck-policy checks passing for those rows; readiness is still `incomplete`, cumulative reading coverage is `144/1232` (`11.7%`), the Tanos N3 vocabulary lane has `509` review candidates (`505` untriaged, `4` deferred), and Gold/Platinum/Obsidian are not started. | `deck:words:ready -- --levels=3`, `deck:words:completion:n3`, `deck:words:reading-audit:n3`, `deck:words:triage:n3`, `deck:words:gap-plan:n3`, `deck:words:expansion-candidates:n3` |
