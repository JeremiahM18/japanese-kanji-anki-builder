...
- JLPT kanji source-evidence registry, source tiers, source lineages, and confidence labels (`high_confidence`, `standard_confidence`, `disputed`, `weak_evidence`, `unknown`): [templates/jlpt_kanji_source_evidence.json](templates/jlpt_kanji_source_evidence.json)
