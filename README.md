...
Word Platinum uses `word-platinum-v3-evidence-lanes`. Current N5/N4 generated word denominator is `987` rows. Structural Platinum is `987/987`, strict Obsidian proof is `735/987`, `252` Platinum entries need Obsidian, and `0` generated N5/N4 word rows are blocked/failing structurally.
...
- `deck:words:platinum:rereview-status -- --levels=5,4` uses generated word rows as the denominator. N5 word `287/287` and N4 word `448/700` Obsidian remain separate from `987/987` structural Platinum.
- `deck:words:platinum:certify-status -- --levels=5,4` is the fail-closed word Obsidian gate. It currently fails because `252` generated N4 word rows still need card-bound strict Obsidian proof.
