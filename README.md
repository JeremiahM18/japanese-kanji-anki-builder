...
All five JLPT levels are first-class product surfaces. N5/N4/N3 kanji are Obsidian certified; N2 structural Platinum is complete but Obsidian proof has not started; N1 is still represented below as generated, readiness, Gold/Silver, and backlog posture.
...
| N2 kanji | `349/349` generated, Gold, and current-standard structural Platinum with `0` remaining; Obsidian not started. | `deck:kanji:review-status`, `deck:platinum:n2`, `deck:ready -- --levels=2` |
