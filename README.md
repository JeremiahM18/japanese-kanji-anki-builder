...
| N5 word | Golden-reviewed at `335/335`; `ready_with_deferred_variants` in curated-only mode; audio, pitch accent, card-back fields, example reading alignment, and looping animations are complete for shipped rows; word platinum has 181 active approvals, 13 deferred/removed rows, 154 generated rows still missing platinum approval, and no `needs_review` blockers under the generated-pitch-label policy |
...
- N5 canonical word rows: `335`
- N5 source-only phrase exclusions: `15`
- N4 canonical word rows: `456`
- Current N5+N4 word rows: `791`
- N5 word reading coverage: `77.3% (266/344)` when built alone
