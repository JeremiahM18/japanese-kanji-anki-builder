...
| Surface | Current state | Main gates |
| --- | --- | --- |
| N5 word | `287` canonical rows plus `20` source-only phrase exclusions. Gold, readiness, tracked-source artifact, and Platinum pass at `287/287`, but stricter word Obsidian enforcement currently certifies only `218/287`; `69` generated N5 word rows need square-zero Obsidian rereview before release-ready claims. | `deck:words:platinum:n5`, `deck:words:platinum:rereview-status -- --levels=5,4`, `deck:words:platinum:certify-status -- --levels=5` |
...
- `deck:words:platinum:rereview-status -- --levels=5,4` uses generated word rows as the denominator. N5 word `218/287` and N4 word `16/700` Obsidian remain separate from `987/987` structural Platinum, and `753` N5/N4 word Platinum entries still need substantive Obsidian rereview proof.
- `deck:words:platinum:certify-status -- --levels=5,4` is the fail-closed word Obsidian gate. It currently fails because `753` generated N5/N4 word rows still need card-bound strict Obsidian proof.
