...
| `ask_hajimete_jlpt_kanji` | [ASK Hajimete JLPT kanji books](https://ask-books.com/series/jlpt-kanji/) | Active restricted manual-citation kanji textbook lane with `77` reviewed assignments from pinned official N1/N3 sample target-entry pages plus exact N2 and N5 checklist pages; N4 remains unsupported until exact assignment proof is verified |
...
| `nihongo_sou_matome_kanji` | [Nihongo Sou Matome textbooks](https://www.ask-books.com/jp/somatome/) | Active restricted manual-citation textbook lane with `673` reviewed assignments and `185` non-importing `source_access_gap` rows from the pinned ignored worksheet; `1354` worksheet rows remain pending |
