...
| N4 word | `192/1034` current word Obsidian v2.5-certified. Gold, current-standard Sapphire, and current-standard Platinum are complete at `1034/1034`; `842` rows still require separate substantive Obsidian v2.5 proof. Platinum approval is not Obsidian proof. | `deck:words:completion:n4`, `deck:words:review:n4`, `deck:words:sapphire:n4`, `deck:words:platinum:n4`, `deck:words:obsidian:rereview-status -- --level=4` |
...
Current word Obsidian v2.5 proof covers `780/1622` current N5/N4 generated word rows. Legacy word Obsidian proof history remains audit-visible at `1118` N5/N4 targets and `1898` raw ledger events; `610` legacy events are superseded by current v2.5 proof. Legacy history does not count as current certification.
