...
| Surface | Current state | Main gates |
| --- | --- | --- |
| N5 word | `287` canonical rows plus `20` source-only phrase exclusions. Gold, readiness, tracked-source artifact, Platinum, and Obsidian all pass at `287/287`; `0` generated N5 word rows remain in the square-zero Obsidian queue. | `deck:words:platinum:n5`, `deck:words:platinum:rereview-status -- --levels=5,4` |
| N4 word | `700` canonical rows after finishing the routed N5-source target-N4 move workload. The generated card surface builds at `700/700` with word audio, pitch, required back-side fields, word-level placement, examples, and labels complete; live readiness is `incomplete` with reading coverage `75.9%` (`573/755`) and a small review-needed/actionable reading backlog. Gold and Platinum now cover `700/700`; Obsidian is `24/700`, so `676` N4 word rows still need square-zero substantive rereview before release-ready claims. | `deck:words:ready -- --levels=4`, `deck:words:completion:n4`, `deck:words:review:n4`, `deck:words:platinum:n4`, `deck:words:expansion-signals -- --levels=5,4` |
...
Word Platinum uses `word-platinum-v3-evidence-lanes`. Current N5/N4 generated word denominator is `987` rows. Structural Platinum is `987/987`, Obsidian is `311/987`, `676` Platinum entries need Obsidian, and `0` generated N5/N4 word rows are blocked/failing structurally. The word source-posture report is scoped to the `987` structurally current-standard entries: `121/987` have independent source families proven, `866/987` are single-source-family, and `0/987` are missing governed source evidence; single-source entries carry `word_source_independence_not_proven`.
...
- `deck:words:platinum:rereview-status -- --levels=5,4` uses generated word rows as the denominator. N4 word `24/700` Obsidian remains separate from `700/700` structural Platinum, and `676` N4 Platinum entries still need substantive Obsidian rereview proof.
