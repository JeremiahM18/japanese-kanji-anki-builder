...
| Surface | Current state | Main gates |
| --- | --- | --- |
| N5 word | `308/826` strict word Obsidian-certified. The 518 remaining current N5 word v2 dictionary-common-pool Silver additions are generated-ready with word audio, pitch, required back-side fields, examples, reading breakdowns, support labels, and readiness, but they have not completed Gold/Sapphire/Platinum/Obsidian. No N5 source-only phrase exclusions remain in the tracked word contract. Live readiness is `ready_with_deferred_variants`; reading coverage is `71.2%` (`245/344`). Release artifact QA, accessibility, and listening checks are still required before release-ready product claims. | `deck:words:obsidian:certify-status -- --levels=5`, `deck:words:ready -- --levels=5` |
...
Strict word Obsidian proof covers `1008/1545` current N5/N4 generated word rows: the N5 Obsidian-certified subset is `308/826`, and the N4 Obsidian-certified subset remains `700/719` after the current word v2 common-word Silver additions. Native Sapphire structural coverage and current-standard Platinum card-surface inspection are complete lower-lane prerequisites for the certified subset; the 518 remaining N5 Silver rows and 19 N4 Silver rows must not be described as Gold, Sapphire, Platinum, or Obsidian-certified.
...
- `deck:words:obsidian:rereview-status -- --levels=5,4` uses generated word rows as the denominator and defaults to canonical JSONL proof for migrated N5/N4 word ledgers. This legacy proof consumer still reports the structural column as Platinum compatibility while native `deck:words:sapphire:*` owns Sapphire coverage. The N5 word `308/826` and N4 word `700/719` Obsidian-certified subsets remain separate from current N5/N4 v2 Silver additions.
- `deck:words:obsidian:certify-status -- --levels=5,4` is the fail-closed word Obsidian gate. It is expected to fail for the current full N5/N4 generated denominator until the 518 remaining N5 and 19 N4 Silver rows complete Gold, Sapphire, Platinum, and Obsidian.
