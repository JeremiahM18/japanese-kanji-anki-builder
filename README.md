...
| N3 word | `179` canonical rows. Silver generated surface now builds at `179/179` with required back-side fields `1969/1969`, word audio `179/179`, Kanjium pitch `179/179`, reading breakdowns, and deck-policy checks passing for those rows; readiness is still `incomplete`, cumulative reading coverage is `180/1232` (`14.6%`), the Tanos N3 vocabulary lane has `449` review candidates (`443` untriaged, `6` deferred), and Gold/Platinum/Obsidian are not started. | `deck:words:ready -- --levels=3`, `deck:words:completion:n3`, `deck:words:reading-audit:n3`, `deck:words:triage:n3`, `deck:words:gap-plan:n3`, `deck:words:expansion-candidates:n3` |
