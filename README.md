...
These commands create or extend local ignored datasets so the decks are usable before you build out full coverage. Use `--merge` when you want to add newly tracked starter entries without disturbing local customizations. Use `--refresh-starter` when tracked starter entries have improved and you want to replace stale starter-derived local copies while preserving non-starter local work. The tracked starter packs now carry complete N5 and N4 kanji curation, the first six N3 kanji starter batches, the first tracked N1 starter batch of 8 kanji, a `339`-row governed N5 canonical word contract plus `13` tracked source-only phrase exclusions, and an expanded governed N4 starter word surface of `183` entries. Editor-local workspace files such as `.vscode/`, `.code-workspace`, and `.history/` are also ignored so local tooling does not dirty the repo.
...
- The governed N4 starter surface now has eight deliberate completion batches. The first promoted `文`, `別`, `別れる`, `問`, `有る`, `郵便`, `曜日`, `洋服`, `理由`, `旅行`, `料金`, `立つ`, `味`, `明るい`, and `野原`; the second adds `不便`, `歌`, `売る`, `晩`, `品`, `部`, `風`, `台風`, `物`, `閉まる`, `野菜`, `用`, `力`, `入力`, `意味`, `今夜`, `道`, `道具`, and `特に`; the third adds `町`, `通う`, `通る`, `兄弟`, `書店`, `転ぶ`, `田`, `今度`, `冬`, `答える`, `答え`, `動く`, `動物`, `同じ`, `同時`, `忙しい`, and `夕食`; the fourth adds `以内`, `入院`, `運動`, `運ぶ`, `映る`, `英文`, `家族`, `歌う`, `計画`, `図書館`, `起こす`, `急に`, `研究`, `牛肉`, `去る`, `建てる`, `公立`, `工場`, `銀色`, `座席`, `作文`, `姉妹`, `質問`, `写真`, `主人`, and `秋`; the fifth adds `待つ`, `待ち合わせ`, `貸す`, `貸し出し`, `台`, `題`, `知る`, `地図`, `地下鉄`, `着る`, `着く`, `昼`, `注意`, `注文`, `茶色`, `町長`, `鳥`, `食堂`, `病気`, and `使い方`; the sixth adds `親切`, `世の中`, `正午`, `切る`, `大切`, `多分`, `体`, `体調`, `時代`, `知らせる`, `競走`, `送る`, `正しい`, `試す`, `試験`, `練習`, `習う`, `近所`, `郵便局`, `自由`, and `集める`; the seventh adds `不足`, `主に`, `京都`, `会員`, `会議室`, `住所`, `作る`, `借りる`, `場所`, `夏休み`, `始まる`, `始める`, `少ない`, `教える`, `教室`, `真ん中`, `言葉`, `週末`, `音楽`, and `黒板`; and the eighth adds `悪い`, `医者`, `音`, `漢字`, `金魚`, `強い`, `授業`, `空港`, `言う`, `中古`, `広い`, `考える`, `黒い`, `思う`, `止まる`, `止める`, `死ぬ`, `私`, `紙`, and `持つ`. That raises canonical N4 word inventory to `183` rows, keeps starter governance at `183/183`, and improves live N4 reading coverage to `210/651` (`32.3%`) with `89` readings now covered by explicit support words.
