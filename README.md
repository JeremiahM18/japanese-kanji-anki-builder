...
| N3 word | `89` canonical rows. Silver generated surface now builds at `89/89` with required back-side fields `979/979`, word audio `89/89`, Kanjium pitch `89/89`, reading breakdowns, and deck-policy checks passing for those rows; readiness is still `incomplete`, cumulative reading coverage is `126/1232` (`10.2%`), the Tanos N3 vocabulary lane has `539` remaining untriaged review candidates, and Gold/Platinum/Obsidian are not started. | `deck:words:ready -- --levels=3`, `deck:words:completion:n3`, `deck:words:reading-audit:n3`, `deck:words:triage:n3`, `deck:words:gap-plan:n3`, `deck:words:expansion-candidates:n3` |
