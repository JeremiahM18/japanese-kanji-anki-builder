...
- N1 kanji golden review coverage is partial: `1180/1231` reviewed (`95.86%`), with `51` remaining as of the current baseline. N1 must not be treated as ready until golden coverage, exact primary-reading audio, and level readiness all pass.
...
| N1 kanji | Golden review partial at `1180/1231` (`95.86%`), with `51` remaining; not ready because golden coverage is incomplete and exact primary-reading audio is missing from exported cards |
