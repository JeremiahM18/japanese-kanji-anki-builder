...
Word Platinum uses `word-platinum-v3-evidence-lanes`. Current N5/N4 generated word denominator is `987` rows. Structural Platinum is `987/987`, stricter Obsidian proof is `471/987`, `516` Platinum entries need Obsidian, and `0` generated N5/N4 word rows are blocked/failing structurally. The word source-posture report is scoped to the `987` structurally current-standard entries: `121/987` have independent source families proven, `866/987` are single-source-family, and `0/987` are missing governed source evidence; single-source entries carry `word_source_independence_not_proven`.
...
- `deck:words:platinum:rereview-status -- --levels=5,4` uses generated word rows as the denominator. N5 word `287/287` and N4 word `184/700` Obsidian remain separate from `987/987` structural Platinum, and `516` N5/N4 word Platinum entries still need substantive Obsidian rereview proof.
- `deck:words:platinum:certify-status -- --levels=5,4` is the fail-closed word Obsidian gate. It currently fails because `516` generated N4 word rows still need card-bound strict Obsidian proof.
