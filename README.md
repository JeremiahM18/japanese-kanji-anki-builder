...
- `npm run deck:words:gap-plan:n4 -- --limit=50` turns the active N4 reading backlog into a ranked batching queue, separating fast curated-example promotions from true editorial research while hiding deferred variants by default. The same command family is available for N3, N2, and N1 so later decks can start from cumulative coverage planning instead of another raw grind.
- The governed N4 starter surface now has nineteen deliberate completion batches. The first promoted `文`, `別`, `別れる`, `問`, `有る`, `郵便`, `曜日`, `洋服`, `理由`, `旅行`, `料金`, `立つ`, `味`, `明るい`, and `野原`; the second adds `不便`, `歌`, `売る`, `晩`, `品`, `部`, `風`, `台風`, `物`, `閉まる`, `野菜`, `用`, `力`, `入力`, `意味`, `今夜`, `道`, `道具`, and `特に`; the third adds `町`, `通う`, `通る`, `兄弟`, `書店`, `転ぶ`, `田`, `今度`, `冬`, `答える`, `答え`, `動く`, `動物`, `同じ`, `同時`, `忙しい`, and `夕食`; the fourth adds `以内`, `入院`, `運動`, `運ぶ`, `映る`, `英文`, `家族`, `歌う`, `計画`, `図書館`, `起こす`, `急に`, `研究`, `牛肉`, `去る`, `建てる`, `公立`, `工場`, `銀色`, `座席`, `作文`, `姉妹`, `質問`, `写真`, `主人`, and `秋`; the fifth adds `待つ`, `待ち合わせ`, `貸す`, `貸し出し`, `台`, `題`, `知る`, `地図`, `地下鉄`, `着る`, `着く`, `昼`, `注意`, `注文`, `茶色`, `町長`, `鳥`, `食堂`, `病気`, and `使い方`; the sixth adds `親切`, `世の中`, `正午`, `切る`, `大切`, `多分`, `体`, `体調`, `時代`, `知らせる`, `競走`, `送る`, `正しい`, `試す`, `試験`, `練習`, `習う`, `近所`, `郵便局`, `自由`, and `集める`; the seventh adds `不足`, `主に`, `京都`, `会員`, `会議室`, `住所`, `作る`, `借りる`, `場所`, `夏休み`, `始まる`, `始める`, `少ない`, `教える`, `教室`, `真ん中`, `言葉`, `週末`, `音楽`, and `黒板`; the eighth adds `悪い`, `医者`, `音`, `漢字`, `金魚`, `強い`, `授業`, `空港`, `言う`, `中古`, `広い`, `考える`, `黒い`, `思う`, `止まる`, `止める`, `死ぬ`, `私`, `紙`, and `持つ`; the ninth adds `空`, `元`, `事`, `気持ち`, `写す`, `終わる`, `最終`, `集まる`, `重い`, `重要`, `春`, `所`, `少し`, `景色`, `親`, `早い`, `走る`, `足`, `多い`, and `仕える`; the tenth adds `屋`, `社会`, `青空`, `赤ちゃん`, `家`, `花火`, `終点`, `事情`, `集中`, `会場`, `色`, and `人気`; the eleventh adds `悪口`, `開始`, `楽しむ`, `起こる`, `歌手`, `帰国`, `仕事中`, `住民`, `手伝う`, `買い物`, `有名人`, `青信号`, `赤信号`, `古本`, `歩道`, and `閉会`; the twelfth adds `悪人`, `開会`, `楽器`, `画家`, `映す`, `家庭`, `家賃`, `館内`, `帰宅`, `急行`, `魚屋`, `花屋`, and `本音`; the thirteenth adds `会計`, `帰り道`, `元々`, `元日`, `住まい`, `寝室`, `新年`, `閉店`, `使い道`, `夏服`, `近道`, `売店`, and `音色`; the fourteenth adds `悪夢`, `近づく`, `寝坊`, `仕方`, `勉強中`, `会費`, `売上`, `開店`, and `映画館`; the fifteenth adds `明ける`, `説明`, `目的`, `方法`, `立てる`, `国立`, `立場`, `閉じる`, `旅`, `文化`, `問題`, and `別に`; the sixteenth adds `中止`, `出発`, `普通`, `通り`, `空く`, `空ける`, `切れる`, `交代`, `代わり`, `広告`, and `広がる`; the seventeenth adds `家計`, `飲料`, `開き`, `気楽`, `観音`, `屋上`, `会釈`, `力士`, `魚 （うお）`, and `牛`; the eighteenth adds `教わる`, `強まる`, `強める`, `最近`, `問う`, `母音`, `起立`, `初夏`, `帰す`, `作業`, and `用いる`; and the nineteenth adds `開く`, `問い`, `問屋`, `手強い`, `観音開き`, `夏毛`, `音信`, and `明朝`. That raises canonical N4 word inventory to `318` rows, keeps starter governance at `318/318`, and improves live cumulative N4 reading coverage to `345/651` (`53.0%`) with `66` readings already satisfied by N5 and `318` covered by the N4 deck itself.
...
| `npm run deck:words:gap-plan:n4 -- --limit=50` | Rank the next word-reading coverage batch so N4/N3/N2/N1 work can proceed from a curated queue instead of raw audit output |
