...
All five JLPT levels are first-class product surfaces. N5/N4 are the current Obsidian certification lane; N3 kanji structural Platinum proof has started; N2/N1 are still represented below as generated, readiness, Gold/Silver, and backlog posture.
...
| N3 kanji | `341/341` generated and Gold; current-standard structural Platinum is `240/341`, Obsidian is `0/341`, and `101` rows still need structural Platinum. | `deck:kanji:review-status`, `deck:ready -- --levels=3`, `deck:platinum:n3`, `deck:kanji:obsidian:rereview-status -- --levels=3` |
...
`deck:kanji:obsidian:rereview-status -- --levels=3` currently reports N3 kanji as `240/341` Platinum, `0/341` Obsidian, `240` Platinum entries needing Obsidian, and `101` blocked/failing rows because structural Platinum coverage is still incomplete. `deck:kanji:obsidian:certify-status -- --levels=3` intentionally fails until those structural and substantive-proof gaps are closed.
