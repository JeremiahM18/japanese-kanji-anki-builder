...
| N1 kanji | `1230/1230` generated and Gold; `40/1230` current-standard structural Platinum from the governed selector, `1190` missing Platinum, and `0/1230` Obsidian proof. | `deck:kanji:review-status`, `deck:ready -- --levels=1`, `deck:platinum:n1`, `deck:platinum:batch -- --level=1 --limit=8 --queue=missing-current-standard` |
