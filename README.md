...
| N2 kanji | `349/349` generated and Gold; `70/349` current-standard structural Platinum with `279` remaining; Obsidian not started. | `deck:kanji:review-status`, `deck:platinum:batch -- --level=2 --limit=10 --queue=missing-current-standard --json`, `deck:ready -- --levels=2` |
