...
| N4 kanji | `212/212` Gold and Platinum. `150/212` are Obsidian; `62` remain in the square-zero Obsidian queue. | `deck:platinum:n4`, `deck:platinum:rereview-status -- --levels=5,4`, `deck:ready -- --levels=4` |
...
- `deck:platinum:rereview-status -- --levels=5,4` currently reports N5/N4 kanji as `292/292` Platinum, `230/292` Obsidian, `62/292` needing Obsidian, and `0/292` blocked/failing.
- `deck:kanji:platinum:certify-status -- --levels=5,4` is the fail-closed kanji Obsidian gate. It currently fails on the `62` N4 kanji that still need Obsidian proof.
