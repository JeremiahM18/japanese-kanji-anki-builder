...
| N5 word | Golden-reviewed at `332/332`; `ready_with_deferred_variants` in curated-only mode; audio, pitch accent, card-back fields, example reading alignment, and looping animations are complete for shipped rows; word platinum has 314 active approvals, 52 deferred/removed rows, 18 generated rows still missing platinum approval, and no `needs_review` blockers under the generated-pitch-label policy |
...
- N2 canonical word rows: `13`
- N1 canonical word rows: `14`
- Current N5+N4 word rows: `790`
- N5 word reading coverage: `68.3% (235/344)` when built alone
- N5 word reading coverage: `69.8% (240/344)` when built with N4 as the selected word-product scope
