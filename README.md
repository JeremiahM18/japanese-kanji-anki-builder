...
| N3 word | `551` canonical Silver rows build/package at `551/551` with audio, pitch, and required back-side fields complete; reading-coverage readiness remains incomplete. The N3-only ready run reports reading coverage `43.6%` (`516/1184`), while the completion audit with N5/N4 counted reports `46.4%` (`549/1184`). Gold, Sapphire, and Platinum are `8/551` current-standard with `543` generated rows still missing each lane. Obsidian proof is not recorded for N3 words. | `deck:words:ready -- --levels=3`, `deck:words:review:n3`, `deck:words:sapphire:n3`, `deck:words:platinum:n3`, `deck:words:completion:n3`, `deck:words:reading-audit:n3` |
