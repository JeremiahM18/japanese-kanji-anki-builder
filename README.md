...
| `npm run nlp:governance-gate` | Run the complete NLP fail-closed gate: model manifest audit, tokenization artifact validation, suggestion artifact validation, and runtime/model-artifact preflight |
