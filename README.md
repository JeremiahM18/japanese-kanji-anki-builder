...
| `npm run data:audit:jlpt:source-levels -- --level=5` | Report active source-claimed N5 candidates, candidates missing from the current N5 contract, disputed missing candidates, and current rows lacking same-level source support without changing decks or readiness |
