...
- Kanji platinum entries created before `kanji-platinum-v2-limitation-aware`, and word platinum entries created before `word-platinum-v3-evidence-lanes`, are legacy/unversioned history, not trusted release coverage, until they are revalidated and pass the default platinum command.
