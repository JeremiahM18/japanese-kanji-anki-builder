...
- JLPT kanji source-evidence registry, source-use policy, source tiers, publisher-independence groups, evidence lineages, and confidence labels (`high_confidence`, `standard_confidence`, `disputed`, `weak_evidence`, `unknown`): [templates/jlpt_kanji_source_evidence.json](templates/jlpt_kanji_source_evidence.json)
