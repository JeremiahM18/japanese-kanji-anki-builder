...
| N5 word | Golden-reviewed at `334/334`; `ready_with_deferred_variants` in curated-only mode; audio, pitch accent, card-back fields, example reading alignment, and looping animations are complete for shipped rows; word platinum has 308 active approvals, 50 deferred/removed rows, 26 generated rows still missing platinum approval, and no `needs_review` blockers under the generated-pitch-label policy |
...
- Current N5+N4 word rows: `792`
- N5 word reading coverage: `69.2% (238/344)` when built alone
- N5 word reading coverage: `70.6% (243/344)` when built with N4 as the selected word-product scope
