...
| N1 kanji | `1230/1230` generated and Gold; `88/1230` current-standard structural Platinum from the governed selector, `80/1230` Obsidian proof, `8` structural Platinum entries still needing Obsidian proof, and `1142` missing Platinum. | `deck:kanji:review-status`, `deck:ready -- --levels=1`, `deck:platinum:n1`, `deck:platinum:batch -- --level=1 --limit=8` |
