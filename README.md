...
| N4 word | `0/1034` current word Obsidian v2.5-certified. Gold and current-standard Sapphire are complete at `1034/1034`; current-standard Platinum is `796/1034`, with `238` rows in the expected Platinum backlog. Platinum approval is not Obsidian proof. | `deck:words:completion:n4`, `deck:words:review:n4`, `deck:words:sapphire:n4`, `deck:words:platinum:n4` |
