...
All five JLPT levels are first-class product surfaces. N5/N4/N3 kanji are Obsidian certified; N2 structural Platinum has started but is incomplete; N1 is still represented below as generated, readiness, Gold/Silver, and backlog posture.
...
| N2 kanji | `349/349` generated and Gold; `100/349` current-standard structural Platinum with `249` remaining; Obsidian not started. | `deck:kanji:review-status`, `deck:platinum:batch -- --level=2 --limit=10 --queue=missing-current-standard --json`, `deck:ready -- --levels=2` |
...
`deck:kanji:obsidian:rereview-status -- --levels=5,4,3` currently reports N5/N4/N3 kanji as `633/633` Platinum, `633/633` Obsidian, `0/633` needing Obsidian, and `0/633` blocked/failing.

`deck:kanji:obsidian:certify-status -- --levels=5,4,3` is the fail-closed kanji Obsidian gate. It currently passes for the full N5/N4/N3 kanji square-zero certification denominator.
