...
| N3 word | `1017` canonical Silver rows build/package at `1017/1017` with audio, pitch, and required back-side fields complete; reading-coverage readiness remains incomplete. The N3-only ready run reports reading coverage `80.2%` (`950/1184`), while the completion audit with N5/N4 counted reports `82.8%` (`980/1184`). Gold, Sapphire, and Platinum are `8/1017` current-standard with `1009` generated rows still missing each lane. Obsidian proof is not recorded for N3 words. | `deck:words:ready -- --levels=3`, `deck:words:review:n3`, `deck:words:sapphire:n3`, `deck:words:platinum:n3`, `deck:words:completion:n3`, `deck:words:reading-audit:n3` |
