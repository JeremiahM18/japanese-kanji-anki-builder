...
| N4 word | `0/1034` current word Obsidian v2.5-certified. Gold is `1034/1034`; current-standard Sapphire is `820/1034`; current-standard Platinum is `700/1034`; the missing Sapphire and Platinum rows are expected downstream backlog. | `deck:words:completion:n4`, `deck:words:review:n4`, `deck:words:sapphire:n4`, `deck:words:platinum:n4` |
