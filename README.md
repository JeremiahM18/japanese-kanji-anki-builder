...
| N3 word | `149` canonical rows. Silver generated surface now builds at `149/149` with required back-side fields `1639/1639`, word audio `149/149`, Kanjium pitch `149/149`, reading breakdowns, and deck-policy checks passing for those rows; readiness is still `incomplete`, cumulative reading coverage is `155/1232` (`12.6%`), the Tanos N3 vocabulary lane has `479` review candidates (`474` untriaged, `5` deferred), and Gold/Platinum/Obsidian are not started. | `deck:words:ready -- --levels=3`, `deck:words:completion:n3`, `deck:words:reading-audit:n3`, `deck:words:triage:n3`, `deck:words:gap-plan:n3`, `deck:words:expansion-candidates:n3` |
