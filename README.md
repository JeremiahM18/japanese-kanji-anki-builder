...
| N3 kanji | `341/341` generated, Gold, and current-standard structural Platinum; Obsidian is `96/341`, and `245` Platinum entries still need substantive Obsidian proof. | `deck:kanji:review-status`, `deck:ready -- --levels=3`, `deck:platinum:n3`, `deck:kanji:obsidian:rereview-status -- --levels=3` |
...
`deck:kanji:obsidian:rereview-status -- --levels=3` currently reports N3 kanji as `341/341` Platinum, `96/341` Obsidian, `245` Platinum entries needing Obsidian, and `0` blocked/failing rows. `deck:kanji:obsidian:certify-status -- --levels=3` intentionally fails until the substantive-proof gap is closed.
