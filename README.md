...
| N3 word | `1081` canonical Silver rows build/package at `1081/1081` with audio, pitch, and required back-side fields complete; reading-coverage readiness remains incomplete. The N3-only ready run reports reading coverage `84.8%` (`1004/1184`), while the completion audit with N5/N4 counted reports `87.2%` (`1032/1184`). Gold is `1081/1081` current-standard with `0` generated rows still missing Gold; Sapphire is `558/1081` current-standard with `523` generated rows still missing Sapphire; Platinum remains `8/1081` current-standard with `1073` generated rows still missing Platinum. Obsidian proof is not recorded for N3 words. | `deck:words:ready -- --levels=3`, `deck:words:review:n3`, `deck:words:sapphire:n3`, `deck:words:platinum:n3`, `deck:words:completion:n3`, `deck:words:reading-audit:n3` |
