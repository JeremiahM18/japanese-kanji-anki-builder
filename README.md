...
| N3 word | `239` canonical rows. Silver generated surface now builds at `239/239` with required back-side fields `2629/2629`, word audio `239/239`, Kanjium pitch `239/239`, reading breakdowns, and deck-policy checks passing for those rows; readiness is still `incomplete`, cumulative reading coverage is `215/1232` (`17.5%`), the Tanos N3 vocabulary lane has `389` review candidates (`383` untriaged, `6` deferred), and Gold/Platinum/Obsidian are not started. | `deck:words:ready -- --levels=3`, `deck:words:completion:n3`, `deck:words:reading-audit:n3`, `deck:words:triage:n3`, `deck:words:gap-plan:n3`, `deck:words:expansion-candidates:n3` |
