...
| `npm run data:template:jlpt:textbook-source -- --source=shin_kanzen_master_kanji --priority=source-level-deltas --source-level=5 --limit=23` | Create an ignored manual-review worksheet for active source-claimed N5 deltas outside the current operational contract |
