...
| N3 word | `209` canonical rows. Silver generated surface now builds at `209/209` with required back-side fields `2299/2299`, word audio `209/209`, Kanjium pitch `209/209`, reading breakdowns, and deck-policy checks passing for those rows; readiness is still `incomplete`, cumulative reading coverage is `194/1232` (`15.7%`), the Tanos N3 vocabulary lane has `419` review candidates (`413` untriaged, `6` deferred), and Gold/Platinum/Obsidian are not started. | `deck:words:ready -- --levels=3`, `deck:words:completion:n3`, `deck:words:reading-audit:n3`, `deck:words:triage:n3`, `deck:words:gap-plan:n3`, `deck:words:expansion-candidates:n3` |
