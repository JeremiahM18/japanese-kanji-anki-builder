...
| N3 kanji | `341/341` generated and Gold; current-standard structural Platinum is `96/341`, Obsidian is `0/341`, and `245` rows still need structural Platinum. | `deck:kanji:review-status`, `deck:ready -- --levels=3`, `deck:platinum:n3`, `deck:kanji:obsidian:rereview-status -- --levels=3` |
