...
- The governed VOICEVOX Docker helper should bind host `127.0.0.1:50021` to container port `50121`; broad host-port publishing is treated as stale container shape.
