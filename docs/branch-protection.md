...
Changes that affect JLPT taxonomy, starter curation, golden review placement, or deck-membership logic also require `npm run data:audit:jlpt` and `npm run data:audit:jlpt:sources -- --strict` before merge.
