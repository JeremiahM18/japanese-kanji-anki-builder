...
| `npm run deck:platinum:n1` | Run the N1 kanji Platinum gate; the trusted N1 Platinum scope is currently `288/1230`, so the full-level gate fails closed until all generated N1 rows have fresh governed current-standard entries |
