...
| `npm run data:build:kanji-field-source-contract` | Build the tracked N5 kanji card-field source contract from current-standard Platinum Japanese-source evidence without reading ignored `data/` inputs |
