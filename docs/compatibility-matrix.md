...
| Client | Status | Notes |
| --- | --- | --- |
| Anki desktop (Windows) | Intended; unverified for `v0.3.0-beta.5` | Native import/render QA was not performed for the automation-reviewed preview |
| Anki desktop (macOS) | Intended; unverified for `v0.3.0-beta.5` | Native import/render QA was not performed for the automation-reviewed preview |
| Anki desktop (Linux) | Intended; unverified for `v0.3.0-beta.5` | APKG structure and packaged Golden fields are inspected, but native client behavior was not exercised |
