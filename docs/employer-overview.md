...
| Proof model | Canonical JSONL proof ledger validates with `2300` events across 6 ledger files. | Certification evidence is tracked, queryable, and replayable. |
