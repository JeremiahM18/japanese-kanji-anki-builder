...
| Governed surfaces | Current generated denominators cover `2212` core kanji rows and `2128` word rows across JLPT N5-N1. | The system is a multi-surface data product, not a single static deck. |
...
| Words | `2128/2128` across N5-N1 | `987/2128` | The lock covers N5-N4. Remaining generated word rows are not Obsidian-certified. |
