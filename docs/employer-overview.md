...
| Governed surfaces | Current generated denominators cover `2212` core kanji rows and `2132` word rows across JLPT N5-N1. | The system is a multi-surface data product, not a single static deck. |
...
| Words | `2132/2132` across N5-N1 | `987/2132` | The lock covers N5-N4. Remaining generated word rows are not Obsidian-certified. |
