...
| Proof model | Canonical JSONL proof ledger validates with `2600` events across 6 ledger files. | Certification evidence is tracked, queryable, and replayable. |
...
| Words | `2505/2505` across N5-N1 | `500/2505` current v2.5 | Current word Obsidian v2.5 covers the current N5 v2.5 batches. Legacy N5/N4 word proof history remains audit-visible, but it is not current v2.5 certification. |
