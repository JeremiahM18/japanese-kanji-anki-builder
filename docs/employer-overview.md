...
| Proof model | Canonical JSONL proof ledger validates with `2110` events across 6 ledger files. | Certification evidence is tracked, queryable, and replayable. |
...
| Words | `2505/2505` across N5-N1 | `10/2505` current v2.5 | Current word Obsidian v2.5 covers the 10-row N5 pilot. Legacy N5/N4 word proof history remains audit-visible, but it is not current v2.5 certification. |
