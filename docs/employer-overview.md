...
| Governed surfaces | Current generated denominators cover `2212` core kanji rows and `2743` word rows across JLPT N5-N1. | The system is a multi-surface data product, not a single static deck. |
...
| Words | `2743/2743` across N5-N1 | `1008/2743` | The lock covers the 308-row N5 and 700-row N4 Obsidian-certified subsets. Current N5/N4 word v2 Silver additions are generated-ready but not Obsidian-certified. |
