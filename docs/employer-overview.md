...
| Proof model | Canonical JSONL proof ledger validates with `2100` events across 6 ledger files. | Certification evidence is tracked, queryable, and replayable. |
...
| Words | `2505/2505` across N5-N1 | `1118/2505` | The lock covers the 418-row N5 and 700-row N4 Obsidian-certified subsets. Current N5 rows without Obsidian proof and N4 word v2 Silver additions are generated-ready but not Obsidian-certified. |
