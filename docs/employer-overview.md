...
| Governed surfaces | Current generated denominators cover `2212` core kanji rows and `1400` word rows across JLPT N5-N1. | The system is a multi-surface data product, not a single static deck. |
...
| Words | `1400/1400` across N5-N1 | `987/1400` | The lock covers N5-N4. Remaining generated word rows are not Obsidian-certified. |
