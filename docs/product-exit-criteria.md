...
- N5 word: golden-reviewed at `314/314` and `ready_with_deferred_variants`; word platinum has 232 active approvals, 34 deferred/removed rows, 82 generated rows still missing platinum approval, and no `needs_review` blockers under the generated-pitch-label policy
