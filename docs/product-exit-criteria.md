...
- N5 word: golden-reviewed at `343/343` and `ready_with_deferred_variants`; word platinum has 51 active approvals, 5 deferred/removed rows, and no `needs_review` blockers under the generated-pitch-label policy
- N4 word: golden-reviewed at `455/455`; selected-scope N5+N4 readiness is currently blocked by missing governed word audio for `発音|はつおん`; word platinum has `0` entries and fails until all generated N4 words have active approvals
