...
- N2 kanji: Gold-reviewed and current local deck readiness passes with complete exported media and exact primary-reading audio; structural Platinum is in progress at `100/349` current-standard entries with `249` remaining; Obsidian not started
