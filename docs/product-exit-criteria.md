...
- N1 kanji: Gold-reviewed at `1230/1230`; current local deck readiness passes with complete exported media and exact primary-reading audio; governed structural Platinum batching has started at `88/1230` current-standard entries with `56/1230` canonical Obsidian proof, `32` structural Platinum entries still needing Obsidian proof, and `1142` missing Platinum
