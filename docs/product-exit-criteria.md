...
- N4 word: expanded to `569` governed rows and current word-level placement audit passes for N4 at `0/569` violations; N4 word completion remains blocked by active triage before fresh golden/platinum review, import QA, accessibility, and listening checks
