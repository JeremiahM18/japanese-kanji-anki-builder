...
- N3 kanji: Gold-reviewed and current local deck readiness passes with complete exported media and exact primary-reading audio; current-standard structural Platinum proof has started at `72/341`, Obsidian is `0/341`, `72` Platinum entries still need Obsidian proof, and `269` generated rows still need structural Platinum
