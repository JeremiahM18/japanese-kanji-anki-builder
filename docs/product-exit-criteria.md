...
- N5 word: golden-reviewed at `343/343` and `ready_with_deferred_variants`; word platinum has 81 active approvals, 5 deferred/removed rows, and no `needs_review` blockers under the generated-pitch-label policy
