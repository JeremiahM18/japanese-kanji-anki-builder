...
- N5 word: golden-reviewed and `ready_with_deferred_variants`; word platinum has 14 active approvals and 10 blocked `needs_review` entries from the first current-policy review batch
