...
- N4 word: expanded to `569` governed rows and current word-level placement and golden review pass against the generated N4 surface; N4 word completion remains blocked by active triage before platinum review, import QA, accessibility, and listening checks
