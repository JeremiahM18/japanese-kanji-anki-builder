...
Gold coverage is required before a level can be trusted for ongoing work. Sapphire coverage is required before a level can be structurally locked. Future Platinum content certification requires Sapphire first and must not be claimed until its dedicated schema/gate exists and passes. Obsidian proof is required before claiming substantive current-version certification. Gold-reviewed and Deck Ready do not mean release-ready.
