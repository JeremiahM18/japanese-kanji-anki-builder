...
- N3 kanji: Gold-reviewed and current local deck readiness passes with complete exported media and exact primary-reading audio; current-standard structural Platinum proof has started at `216/341`, Obsidian is `0/341`, `216` Platinum entries still need Obsidian proof, and `125` generated rows still need structural Platinum
