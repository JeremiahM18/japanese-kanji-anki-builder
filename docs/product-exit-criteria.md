...
- N2 kanji: Gold-reviewed and current local deck readiness passes with complete exported media and exact primary-reading audio; structural Platinum is complete at `349/349` current-standard entries with `0` remaining; canonical Obsidian proof is started at `8/349` with `341` remaining and `0` blocked/failing
