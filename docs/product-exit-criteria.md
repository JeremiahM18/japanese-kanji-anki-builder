...
- N5 kanji: golden-reviewed and current local deck readiness passes with complete exported media and exact primary-reading audio; platinum restarted at `12/80` active entries under field-bound evidence validation
