...
- N4 word: expanded to `667` governed rows and current word-level placement, Gold regression, automated readiness, and current-standard Platinum structural coverage pass at `667/667`. Current live completion reports `ready_with_deferred_variants`, expansion signals are exhausted, reading coverage is `578/755` (`76.6%`), and only deferred variants remain. `0/667` generated N4 word rows are Obsidian certified, so all N4 word rows remain in the square-zero Obsidian queue and N4 remains blocked before release-ready claims until full Obsidian completion, import QA, accessibility, and listening checks
- Word Obsidian provenance: `deck:words:platinum:rereview-status -- --levels=5,4` currently reports N5/N4 combined `954` generated active word rows, `954/954` Platinum structural pass, `8/954` Obsidian certified, `946` Platinum entries needing Obsidian, and `0/954` blocked/failing rows. The generated-row denominator is the square-zero Obsidian denominator; for N4 word that means `0/667` Obsidian certified, not `667/667` just because Platinum structural coverage exists. The missing-proof marker is `missing_substantive_current_standard_word_rereview_proof`; `revalidatedAt` and lane-valid `current-standard-review` text are not treated as standalone proof of substantive post-v3 human rereview.
...
- Platinum governance gate: `deck:platinum:governance-gate` currently passes against local real generated N5/N4 rows, with warnings for N5/N4 kanji and word missing Obsidian proof, word single-source-family posture, bulk-template revalidation summaries, missing card-specific revalidation summaries, marker-only example-quality automation, and zero active verification limitations. This gate does not edit cards and does not prove word Obsidian certification or release readiness.
