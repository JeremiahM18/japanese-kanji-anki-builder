...
- N2 kanji: Gold-reviewed and current local deck readiness passes with complete exported media and exact primary-reading audio; structural Platinum and canonical Obsidian proof are complete at `349/349` current-standard entries with `0` remaining and `0` blocked/failing
- N1 kanji: Gold-reviewed at `1230/1230`; current local deck readiness passes as a mechanical generated-artifact and media signal only, not content trust or release approval; trusted current-standard structural Platinum has restarted at `8/1230`, trusted canonical Obsidian proof remains reset to `0/1230`, and `1222` generated rows require fresh Platinum review before any Obsidian proof is recorded
