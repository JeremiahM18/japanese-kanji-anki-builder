...
- N4 word: golden review partial at `384/460` and stabilized as `ready_with_deferred_variants` when built with N5 as the selected word-product scope; platinum not started
