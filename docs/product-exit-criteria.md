...
- N1 kanji: Gold-reviewed at `1230/1230`; current local deck readiness passes as a mechanical generated-artifact and media signal only, not content trust or release approval; trusted current-standard structural Platinum is `136/1230`, trusted canonical Obsidian proof remains reset to `0/1230`, and `1094` generated rows require fresh Platinum review before any Obsidian proof is recorded
