...
- N5 kanji: Gold-reviewed and current local deck readiness passes with complete exported media and exact primary-reading audio; Platinum Candidate gates pass at `80/80`, and `80/80` are Platinum certified with explicit non-mechanical rereview proof
- N4 kanji: Gold-reviewed and current local deck readiness passes with complete exported media and exact primary-reading audio; Platinum Candidate gates pass at `212/212` with `0` active verification limitations and `0` remaining core N4 structural gaps, and `90/212` are Platinum certified; the remaining `122` stay in the square-zero certification queue
- N3 kanji: Gold-reviewed and current local deck readiness passes with complete exported media and exact primary-reading audio; Platinum Candidate not started
- N2 kanji: Gold-reviewed and current local deck readiness passes with complete exported media and exact primary-reading audio; Platinum Candidate not started
- N1 kanji: Gold-reviewed at `1230/1230`; current local deck readiness passes with complete exported media and exact primary-reading audio; Platinum Candidate not started
...
- Kanji Platinum certification provenance: `deck:platinum:rereview-status -- --levels=5,4` currently reports N5/N4 combined `292/292` Platinum Candidate pass, `170/292` Platinum certified, `122/292` candidate-only entries needing certification, and `0/292` blocked/failing. The missing-proof marker is `missing_substantive_current_standard_rereview_proof`; `revalidatedAt` and lane-valid `current-standard-review` text are not treated as standalone proof of substantive post-v3 human rereview.
...
- N5 word: expanded to `287` canonical governed rows plus `20` tracked source-only phrase exclusions; current word-level placement, Gold, tracked-source artifact, automated readiness, and Platinum Candidate checks pass at `287/287`, but only `8/287` are Platinum certified and `279/287` remain in the square-zero certification queue; manual import QA, accessibility, and listening checks are still required before release-ready status
- N4 word: expanded to `667` governed rows and current word-level placement and Gold review pass, but readiness remains incomplete. Platinum Candidate word review exists for `96/667`, but `0/667` generated N4 word rows are Platinum certified; those `96` candidate-only entries need certification and the other `571` generated rows still lack active current-standard structural entries. Current live checks report completion `incomplete` with one active planning item (`元 -> げん`), and `deck:words:ready -- --levels=4 --require-no-active-triage` remains blocked by active triage before full Platinum completion, import QA, accessibility, and listening checks
- Word Platinum certification provenance: `deck:words:platinum:rereview-status -- --levels=5,4` currently reports N5/N4 combined `954` generated active word rows, `383/954` Platinum Candidate pass, `8/954` Platinum certified, `375` candidate-only entries needing certification, and `571/954` blocked/failing because N4 word candidate coverage is incomplete. The generated-row denominator is the square-zero certification denominator; for N4 word that means `0/667` Platinum certified, not `0/96`. The missing-proof marker is `missing_substantive_current_standard_word_rereview_proof`; `revalidatedAt` and lane-valid `current-standard-review` text are not treated as standalone proof of substantive post-v3 human rereview.
...
- Platinum governance gate: `deck:platinum:governance-gate` currently passes against local real generated N5/N4 rows, with warnings for N5/N4 kanji and word missing Platinum certification proof, N4 word incomplete candidate coverage, word single-source-family posture, bulk-template revalidation summaries, missing card-specific revalidation summaries, marker-only example-quality automation, and zero active verification limitations. This gate does not edit cards and intentionally allows known incomplete N4 word coverage only when blocked rows are missing active current-standard structural entries rather than dirty reviewed entries.
