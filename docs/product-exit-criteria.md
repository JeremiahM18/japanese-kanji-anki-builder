...
- N5 word: golden-reviewed at `343/343` and `ready_with_deferred_variants`; word platinum has 17 active approvals, 5 later-level deferred rows, and 2 blocked `needs_review` pitch-provenance rows
