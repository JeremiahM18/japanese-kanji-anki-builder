...
- N5 kanji: golden-reviewed and current local deck readiness passes with complete exported media and exact primary-reading audio; current v3 structural platinum gates pass at `80/80`, but explicit non-mechanical substantive rereview provenance is not proven for any N5 entry yet
- N4 kanji: golden-reviewed and current local deck readiness passes with complete exported media and exact primary-reading audio; current v3 structural platinum gates pass at `212/212` with `0` active verification limitations and `0` remaining core N4 platinum gaps, but explicit non-mechanical substantive rereview provenance is not proven for any N4 entry yet
...
- Kanji platinum rereview provenance: `deck:platinum:rereview-status -- --levels=5,4` currently reports N5/N4 combined `292/292` current v3 structural pass, `0/292` substantive current-standard review proven, `292/292` needs substantive rereview, and `0/292` blocked/failing. The missing-proof marker is `missing_substantive_current_standard_rereview_proof`; `revalidatedAt` and lane-valid `current-standard-review` text are not treated as standalone proof of substantive post-v3 human rereview.
