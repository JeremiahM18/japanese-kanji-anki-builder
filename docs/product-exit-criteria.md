...
- N5 kanji: golden-reviewed and current local deck readiness passes with complete exported media and exact primary-reading audio; current v3 structural gates pass at `80/80`, but only `30/80` have explicit non-mechanical substantive rereview proof and `50/80` remain in the square-zero rereview queue
- N4 kanji: golden-reviewed and current local deck readiness passes with complete exported media and exact primary-reading audio; current v3 structural gates pass at `212/212` with `0` active verification limitations and `0` remaining core N4 structural gaps, but `0/212` have explicit non-mechanical substantive rereview proof, so all `212` remain in the square-zero rereview queue
...
- Kanji platinum rereview provenance: `deck:platinum:rereview-status -- --levels=5,4` currently reports N5/N4 combined `292/292` structural v3 gate pass, `30/292` substantive current-standard review proven, `262/292` structural-only entries needing substantive rereview, and `0/292` blocked/failing. The missing-proof marker is `missing_substantive_current_standard_rereview_proof`; `revalidatedAt` and lane-valid `current-standard-review` text are not treated as standalone proof of substantive post-v3 human rereview.
...
- N5 word: expanded to `287` canonical governed rows plus `20` tracked source-only phrase exclusions; current word-level placement, golden, tracked-source artifact, automated readiness, and current-standard structural word checks pass at `287/287`, but only `8/287` have explicit non-mechanical substantive rereview proof and `279/287` remain in the square-zero rereview queue; manual import QA, accessibility, and listening checks are still required before release-ready status
- N4 word: expanded to `667` governed rows and current word-level placement and golden review pass, but readiness remains incomplete. Current-standard structural word review exists for `96/667`, but `0/667` generated N4 word rows have explicit non-mechanical substantive rereview proof; those `96` structural-only entries need rereview and the other `571` generated rows still lack active current-standard structural entries. Current live checks report completion `incomplete` with one active planning item (`元 -> げん`), and `deck:words:ready -- --levels=4 --require-no-active-triage` remains blocked by active triage before full platinum completion, import QA, accessibility, and listening checks
- Word platinum rereview provenance: `deck:words:platinum:rereview-status -- --levels=5,4` currently reports N5/N4 combined `954` generated active word rows, `383/954` structural v3 gate pass, `8/954` substantive current-standard review proven, `375` structural-only entries needing substantive rereview, and `571/954` blocked/failing because N4 word structural coverage is incomplete. The generated-row denominator is the square-zero rereview denominator; for N4 word that means `0/667` substantive proof, not `0/96`. The missing-proof marker is `missing_substantive_current_standard_word_rereview_proof`; `revalidatedAt` and lane-valid `current-standard-review` text are not treated as standalone proof of substantive post-v3 human rereview.
...
- Platinum governance gate: `deck:platinum:governance-gate` currently passes against local real generated N5/N4 rows, with warnings for N5/N4 kanji and word missing substantive rereview proof, N4 word incomplete structural coverage, word single-source-family posture, bulk-template revalidation summaries, missing card-specific revalidation summaries, marker-only example-quality automation, and zero active verification limitations. This gate does not edit cards and intentionally allows known incomplete N4 word coverage only when blocked rows are missing active current-standard structural entries rather than dirty reviewed entries.
