...
- N5 word: golden-reviewed at `343/343` and `ready_with_deferred_variants`; word platinum has 26 active approvals, 5 later-level deferred rows, and no `needs_review` pitch-provenance blockers under the generated-pitch-label policy
