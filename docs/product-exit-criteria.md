...
- N1 kanji: Gold-reviewed at `1230/1230`; current local deck readiness passes with complete exported media and exact primary-reading audio; governed structural Platinum batching has started at `64/1230` current-standard entries with `1166` missing Platinum and `0/1230` Obsidian proof
