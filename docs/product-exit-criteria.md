...
- N3 kanji: Gold-reviewed and current local deck readiness passes with complete exported media and exact primary-reading audio; current-standard structural Platinum proof and Obsidian proof are complete at `341/341`, with `0` Platinum entries needing substantive Obsidian proof and `0` generated rows needing structural Platinum
- N2 kanji: Gold-reviewed and current local deck readiness passes with complete exported media and exact primary-reading audio; structural Platinum is complete at `349/349` current-standard entries with `0` remaining; canonical Obsidian proof is partial at `128/349` with `221` remaining and `0` blocked/failing
