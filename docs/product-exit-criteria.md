...
- N2 kanji: Gold-reviewed and current local deck readiness passes with complete exported media and exact primary-reading audio; structural Platinum is in progress at `160/349` current-standard entries with `189` remaining; Obsidian not started
