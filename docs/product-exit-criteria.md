...
| Platinum | Gates current card-surface inspection. It records human review of learner-facing reading, meaning, example, notes/support surface, media identity, level/product fit, evidence boundaries, limitations, and final keep/fix/defer/remove judgment under the current Platinum schema. |
| Obsidian | Certifies explicit non-mechanical current-version rereview proof for the live card. |

Gold coverage is required before a level can be trusted for ongoing work. Sapphire coverage is required before a level can be structurally locked. Platinum requires the live card surface to pass the Platinum gate. Obsidian proof is required before claiming substantive current-version certification. Gold-reviewed and Deck Ready do not mean release-ready.
