...
- N3 kanji: Gold-reviewed and current local deck readiness passes with complete exported media and exact primary-reading audio; current-standard structural Platinum proof has started at `192/341`, Obsidian is `0/341`, `192` Platinum entries still need Obsidian proof, and `149` generated rows still need structural Platinum
