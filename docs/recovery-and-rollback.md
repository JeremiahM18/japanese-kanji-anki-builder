...
For card content defects, rerun the applicable Gold, native Sapphire or structural compatibility, future Platinum, Obsidian, source, audio, stroke-order, accessibility, and product gates from [verification.md](verification.md). Do not use green package output as proof that real card data was rereviewed.
