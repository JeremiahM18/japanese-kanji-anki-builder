...
2. Run the manual [release QA checklist](release-qa-checklist.md), including the current level-specific Gold regression, Sapphire/Platinum-compatibility gate where applicable, accessibility review, and Anki spot-review expectations.
...
| `deck:kanji:review-status` | Generated, Gold, Sapphire/Platinum-compatibility coverage, revalidation backlog, structural, and duplicate-claim status for core and additional kanji decks. | Source-evidence confidence, Obsidian completion for missing rows, future Platinum content certification, or manual Anki QA. |
...
| `deck:kanji:additional:platinum:n*` | Field-bound Sapphire/Platinum-compatibility gate for generated additional-unverified kanji cards, or an empty-surface pass when `deck:kanji:additional:ready` proves the generated additional deck is empty by governed suppression. | Core contract movement, source-evidence confidence, source-governance storage, core kanji Sapphire/Platinum-compatibility coverage, future Platinum content certification, or manual Anki QA. |
