...
| `product:release-qa:evidence` | Validates the completed release-specific evidence packet, including APKG import, managed-media provenance, manual Anki import, mobile QA, screen-reader/accessibility, listening QA, accepted source-governance posture for incomplete source depth, and empty known blockers. | Obsidian native/fluent-quality content certification, hosted attestation proof, Platinum proof, source-taxonomy confidence, or human-reviewed provenance. |
