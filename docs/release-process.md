...
2. Run the manual [release QA checklist](release-qa-checklist.md), including the current level-specific Gold regression, native Sapphire structural gate, Platinum where applicable, accessibility review, and Anki spot-review expectations.
