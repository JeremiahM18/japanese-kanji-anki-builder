...
| `product:release-qa:evidence` | Validates the completed release-specific evidence packet, including APKG import, managed-media provenance, manual Anki import, mobile QA, screen-reader/accessibility, listening QA, source-governance posture, and empty known blockers. | The underlying human judgment itself, hosted attestation proof, Platinum/Obsidian proof, or source-taxonomy confidence. |
