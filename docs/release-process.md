...
| `deck:kanji:review-status` | Generated, Gold, Platinum Candidate, revalidation backlog, structural, and duplicate-claim status for core and additional kanji decks. | Source-evidence confidence, Platinum completion for missing rows, or manual Anki QA. |
...
| `deck:kanji:additional:platinum:n*` | Field-bound Platinum Candidate review for generated additional-unverified kanji cards, or an empty-surface pass when `deck:kanji:additional:ready` proves the generated additional deck is empty by governed suppression. | Core contract movement, source-evidence confidence, source-governance storage, core kanji Platinum Candidate coverage, or manual Anki QA. |
