...
8. Let [.github/workflows/release.yml](../.github/workflows/release.yml) produce the tagged release artifacts, CycloneDX SBOM, dependency-license summary, checksum manifest, provenance attestation, and SBOM attestation.
