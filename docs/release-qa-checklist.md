...
- Treat generated deck rows as the certification denominator. N5 word currently has `588` generated rows with `308` strict Obsidian certifications, and N4 word currently has `719` generated rows with `700` strict Obsidian certifications; the 280 current N5 word rows without Obsidian proof must complete Obsidian, including 181 that still need current-standard Platinum first, and the 19 current N4 word v2 Silver additions must complete Gold, Sapphire, Platinum, and Obsidian before `deck:words:obsidian:certify-status -- --levels=5,4` can pass for the current full N5/N4 generated denominator.
...
- Import each word level being shipped into Anki only after the fail-closed Obsidian certification gate and its lower-lane prerequisite gates pass. N5 word is strict non-human governed native/fluent-quality Obsidian-certified at `308/588`; N4 word is strict non-human governed native/fluent-quality Obsidian-certified at `700/719`; the 299 current N5/N4 word rows without Obsidian proof (280 N5, 19 N4) are not release-certifiable until lower lanes and Obsidian proof catch up. N5/N4 still require release artifact QA, accessibility, and listening checks before release-ready product claims.
