...
- Treat generated deck rows as the certification denominator. For example, if N4 word has `667` generated rows and `336` Platinum entries, `0` Obsidian certifications means `0/667` proven, not `0/336`.
