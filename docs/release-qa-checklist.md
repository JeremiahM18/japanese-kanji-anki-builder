...
- Treat generated deck rows as the certification denominator. N5 word currently has `588` generated rows with `40` current word Obsidian v2.5 certifications and `548` rows still needing v2.5 proof. N4 word currently has `719` generated rows with `0` current word Obsidian v2.5 certifications; `700` Platinum-passing rows still need v2.5 proof, and the 19 current N4 word v2 Silver additions must complete Gold, Sapphire, Platinum, and Obsidian before `deck:words:obsidian:certify-status -- --levels=5,4` can pass for the current full N5/N4 generated denominator.
