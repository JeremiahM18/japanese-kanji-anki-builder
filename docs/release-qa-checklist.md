...
- Treat generated deck rows as the certification denominator. For example, N4 word currently has `667` generated rows and `667` Platinum structural entries, but `0` Obsidian certifications still means `0/667` proven.
