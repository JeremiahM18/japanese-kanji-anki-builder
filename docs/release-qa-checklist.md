...
- Import each kanji level being shipped into Anki. Current ready local kanji levels are N5, N4, N3, N2, and N1. Current-standard Platinum coverage is complete for N5/N4/N3/N2; N1 is only partially trusted at `312/1230`, with `918` rows still requiring fresh Platinum review before any version-1 lock. N1 deck readiness is mechanical/media readiness only until Platinum and proof gates catch up.
