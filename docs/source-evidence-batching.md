...
This workflow applies only to the JLPT kanji source-evidence layer. It does not move kanji, move words, update deck content, change Gold regression or native Sapphire coverage, claim future Platinum content certification, or alter readiness.
...
Do not copy textbook lists, passages, prompts, questions, answers, or source excerpts into the TSV. Do not include deck previews or Gold/Sapphire/future Platinum decisions in the source batch.
