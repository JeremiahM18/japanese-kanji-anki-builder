...
const { buildWordStudyEntryKey, loadWordStudyData } = require("../src/datasets/wordStudyData");
const { loadWordPitchAccentData, normalizeWordPitchAccentData } = require("../src/datasets/wordPitchAccentData");
const { describeVoicevoxError } = require("../src/services/voicevoxDoctorService");
const { invokeCliMain } = require("../src/utils/cliArgs");
const { mapWithConcurrency } = require("../src/utils/concurrency");
const { katakanaToHiragana } = require("../src/utils/japanese");
const {
    classifyAccent,
    collectDeckEligibleEntries,
} = require("./importKanjiumPitchAccents");
