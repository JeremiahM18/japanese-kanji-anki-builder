...
async function main() {
    ...
    const summary = {
        ...
        coreRetainedDuplicateKanji: physicalSelection.coreRetainedDuplicateKanji.length,
        suppressedDuplicateClaims: physicalSelection.suppressedDuplicateClaims.length,
        exports,
        blankAudioRows,
