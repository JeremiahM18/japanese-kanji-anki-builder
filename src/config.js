...
const schema = z.object({
    ...
    kanjiComponentContractPath: z.string().default("templates/kanji_component_contract.json"),
    ...
    wordStudyDataPath: z.string().default("data/word_study_data.json"),
    ...
    remoteStrokeOrderAnimCjkBaseUrl: z.string().url().optional(),
...
function buildRawConfig(env) {
    return {
        ...
        kanjiComponentContractPath: env.KANJI_COMPONENT_CONTRACT_PATH,
        sentenceCorpusPath: env.SENTENCE_CORPUS_PATH,
        curatedStudyDataPath: env.CURATED_STUDY_DATA_PATH,
        wordStudyDataPath: env.WORD_STUDY_DATA_PATH,
        ...
        remoteStrokeOrderAnimCjkBaseUrl: env.REMOTE_STROKE_ORDER_ANIMCJK_BASE_URL,
        remoteAudioBaseUrl: env.REMOTE_AUDIO_BASE_URL,
        voicevoxEngineUrl: env.VOICEVOX_ENGINE_URL,
        voicevoxSpeakerId: env.VOICEVOX_SPEAKER_ID,
...
function loadConfig({ cwd = process.cwd(), env = process.env, dotEnvFileName = ".env" } = {}) {
    ...
    return {
        ...
        kanjiComponentContractPath: resolveFromCwd(cwd, parsed.kanjiComponentContractPath),
        ...
        wordStudyDataPath: resolveFromCwd(cwd, parsed.wordStudyDataPath),
