...
const curatedEntrySchema = z.object({
    ...
    blockedMeanings: z.array(z.string().min(1)).default([]),
    blockedReadings: z.array(z.string().min(1)).default([]),
    additionalOnReadings: z.array(z.string().min(1)).default([]),
    additionalKunReadings: z.array(z.string().min(1)).default([]),
...
function normalizeCuratedEntry(entry) {
    return curatedEntrySchema.parse({
        ...
        blockedMeanings: normalizeStringArray(entry?.blockedMeanings),
        blockedReadings: normalizeStringArray(entry?.blockedReadings),
        additionalOnReadings: normalizeOrderedStringArray(entry?.additionalOnReadings),
        additionalKunReadings: normalizeOrderedStringArray(entry?.additionalKunReadings),
