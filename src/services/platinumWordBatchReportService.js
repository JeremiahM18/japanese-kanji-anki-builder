...
function formatPlatinumWordBatchReport(report = {}) {
    ...
    const lines = [
        ...
        `Current-standard candidate entries: ${summary.currentStandardPlatinum || 0}`,
        `Platinum certified: ${summary.substantiveRereviewProven || 0}`,
        `Legacy/unversioned platinum: ${summary.legacyOrUnversionedPlatinum || 0}`,
        `Missing Platinum Candidate entries: ${summary.remainingPlatinum || 0}`,
        `Missing current-standard candidate structure: ${summary.remainingCurrentStandard || 0}`,
