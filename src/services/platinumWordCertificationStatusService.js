...
function buildPlatinumWordCertificationStatusSummary(levelReports = []) {
    ...
    return {
        ...
        passed,
        certificationGate: {
            name: "word Platinum-to-Obsidian certification",
...
function formatPlatinumWordCertificationStatusReport(summary = {}) {
    const totals = summary.totals || {};
    const gate = summary.certificationGate || {};
    const lines = [
        "Japanese Kanji Builder Word Platinum Certification Status",
        "",
