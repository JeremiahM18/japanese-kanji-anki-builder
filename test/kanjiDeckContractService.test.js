...
const HEADER = "Kanji\tDisplayWord\tMeaningJP\tPrimaryReading\tKanjiMeanings\tStudyWordKanji\tOnReading\tKunReading\tStrokeOrder\tStrokeOrderImage\tStrokeOrderAnimation\tAudio\tRadical\tNotes\tExampleSentence";
...
test("buildKanjiDeckContractReport accepts individual-kanji card anchors", () => {
    const report = buildKanjiDeckContractReport({
        ...
        tsv: [
            HEADER,
            "車\t車\tcar\tくるま\tcar\t\tオン: シャ\tくん: くるま\t<img src=\"8ECA.gif\" />\t<img src=\"8ECA.png\" />\t<img src=\"8ECA.gif\" />\t[sound:8ECA_車-kanji-reading-車-くるま.wav]\t車\t電車 （でんしゃ） - train\t電車で行きます。",
        ].join("\n"),
    });
